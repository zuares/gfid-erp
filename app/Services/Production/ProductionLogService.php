 ...
 *   - inventory_mutations (event stok produksi: cutting/sewing/QC/finishing/…)
...
class ProductionLogService
{
    ...
    public const SOURCE_LABELS = [
        'cutting_job' => 'Cutting — Bahan baku → WIP',
        'cutting_job_void' => 'Cutting — Void',
        'cutting_job_sisa' => 'Cutting — Sisa kain',
        'cutting_wip' => 'QC Cutting → WIP-CUT',
        'cutting_reject' => 'QC Cutting — Reject',
        'cutting_qc_void' => 'QC Cutting — Dibatalkan',
        'cutting_qc_adjust_in' => 'QC Cutting — Adjust (+)',
        'cutting_qc_adjust_out' => 'QC Cutting — Adjust (−)',
        'App\\Models\\SewingPickup' => 'Ambil Jahit — WIP-CUT → WIP-SEW',
        'sewing_pickup_supply' => 'Ambil Jahit — Kelengkapan',
        'sewing_pickup_supply_followup' => 'Ambil Jahit — Kelengkapan menyusul',
        'sewing_pickup_supply_void_line' => 'Ambil Jahit — Void kelengkapan',
        'sewing_qc_in' => 'Setor Jahit — WIP-SEW → WIP-FIN',
        'sewing_qc_reject' => 'Setor Jahit — Reject',
        'sewing_return_ok' => 'Setor Jahit OK',
        'sewing_return_reject' => 'Setor Jahit Reject',
        'sewing_reject_rework_ok' => 'Setor Ulang (rework)',
        'finishing_bom' => 'Finishing — Konsumsi BOM',
        'finishing_job' => 'Finishing — WIP → Barang Jadi',
        'finishing_qc_in_fg' => 'Finishing QC → FG',
        'finishing_qc_reject' => 'Finishing — Reject',
        'finishing_reject_convert' => 'Finishing — Konversi reject',
        'finishing_repair' => 'Finishing — Repair',
        'production_movement' => 'Perpindahan produksi',
        'wip_fin_adjustment' => 'Adjustment WIP-FIN',
        'wip_normalization' => 'Normalisasi WIP',
        'wip_cleanup' => 'WIP Cleanup',

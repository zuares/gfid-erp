...
<div class="gf-master-page">
    <div class="gf-master-head">
        <div class="gf-master-head-left">
            ...
            <div>
                ...
                <h1 class="gf-master-title">Edit Customer</h1>

                <div class="gf-master-subtitle">
                    {{ $customer->code ?: 'Tanpa kode' }} • {{ $customer->name }}
                </div>
            </div>
        </div>
    ...
    <div class="gf-master-card">
        <div class="gf-master-card-body">
            ...
            <form action="{{ route('master.customers.update', $customer) }}" method="POST" autocomplete="off" class="gf-form">
                @csrf
                @method('PUT')

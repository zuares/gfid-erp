...
<div class="gf-master-page">
    <div class="gf-master-head">
        <div class="gf-master-head-left">
            ...
            <div>
                ...
                <h1 class="gf-master-title">Edit Supplier</h1>
        ...
        <div class="gf-master-actions">
            <a href="{{ route('master.suppliers.show', $supplier) }}" class="btn btn-outline-secondary btn-sm">
    ...
    <div class="gf-master-card">
        <div class="gf-master-card-body">
            ...
            <form method="POST" action="{{ route('master.suppliers.update', $supplier) }}" class="gf-form">
                @csrf
                @method('PUT')
                ...
                <div class="gf-form-grid">
                    ...
                    <div>
                        ...
                        <select name="active" class="form-select">
                            <option value="1" @selected(old('active', (string) $supplier->active) == '1')>Aktif</option>
                            <option value="0" @selected(old('active', (string) $supplier->active) == '0')>Nonaktif</option>
                        </select>
                    </div>
                        ...
                        <div class="d-flex flex-wrap gap-3 mt-1">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox"
                                    ...
                                    id="pt_e_{{ $val }}"
                                    {{ $checked ? 'checked' : '' }}>
                                <label class="form-check-label" for="pt_e_{{ $val }}">{{ $label }}</label>
                            </div>
                            @endforeach
                        </div>
                        <div class="text-muted" style="font-size:.75rem; margin-top:.25rem;">Kosong = bisa untuk semua jenis PO</div>
                    </div>

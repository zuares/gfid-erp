...
@section('content')
    <div class="supplier-form container py-3">
        <div class="d-flex align-items-start justify-content-between gap-3 flex-wrap">
            <div>
                <h1 class="h5 mb-1">Tambah Supplier</h1>
                <div class="muted" style="font-size:.9rem">Buat master supplier baru.</div>
            </div>
            <div class="d-flex gap-2">
                <a href="{{ route('master.suppliers.index') }}" class="btn btn-outline-secondary btn-pill">Back</a>
            </div>
        </div>
            ...
            <form method="POST" action="{{ route('master.suppliers.store') }}">
                ...
                <div class="row g-2">
                    <div class="col-md-4">
                        ...
                        <input name="code" value="{{ old('code') }}" class="form-control" required autofocus>
                        @error('code')

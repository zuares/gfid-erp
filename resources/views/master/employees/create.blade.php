...
<div class="gf-master-page">
    <div class="gf-master-head">
        <div class="gf-master-head-left">
            ...
            <div>
                ...
                <h1 class="gf-master-title">Karyawan Baru</h1>

                <div class="gf-master-subtitle">
                    Tambahkan karyawan untuk produksi, payroll, operator, atau admin.
                </div>
            </div>
        </div>
    ...
    <div class="gf-master-card">
        <div class="gf-master-card-body">
            ...
            <form action="{{ route('master.employees.store') }}" method="POST" autocomplete="off" class="gf-form">
                @csrf

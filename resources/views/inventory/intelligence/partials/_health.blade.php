            ...
            <table class="table table-hover align-middle table-list" data-ii-table>
                <thead style="background: rgba(241, 245, 249, 0.5); position: sticky; top: 0; z-index: 10;">
                    <tr>
                        ...
                        <th class="text-end gf-hide-mobile">WIP (Sedang Jahit)</th>
                        <th class="text-end gf-hide-mobile">Jual/hari</th>
                        <th class="text-end" title="Cover = ready ÷ laju jual">Cover (hr)</th>
                        <th class="text-end gf-hide-mobile" title="Pipe = (ready + WIP) ÷ laju jual">Pipeline (hr)</th>

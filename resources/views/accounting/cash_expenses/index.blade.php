...
{{-- AUTO COMPRESS CASH EXPENSE PROOF PHOTO --}}
<script>
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelectorAll('input[name="proof_photo"], [data-ce-proof-input]').forEach(function (input) {
        input.addEventListener('change', async function () {
            ...
            const label = input.closest('label, .ce-field, .form-group, .mb-3, div');
            const nameEl = label ? label.querySelector('[data-ce-proof-name], [data-proof-file-name]') : null;
...
{{-- AUTO HIDE CASH EXPENSE CATATAN ONLY --}}
<style>
input[name="note"],
input[name="notes"],
input[name="catatan"],

    ...
    @push('scripts')
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                window.initItemSuggestInputs = function() {
                    const wraps = document.querySelectorAll('.item-suggest-wrap:not([data-suggest-inited="1"])');
                    wraps.forEach(wrap => {
            ...
            function setupItemSuggest(wrap) {
                ...
                function selectItem(item) {
                    ...
                    if (row) {
                        ...
                        if (catLabel) {
                            catLabel.textContent = categoryName || (categoryId ? '#' + categoryId : '-');
                        }
                    }
                    ...
                    if (rowEl) {
                        const nextFocusable = rowEl.querySelector('.bundle-qty');
                        if (nextFocusable) {
                            setTimeout(() => {
                                nextFocusable.focus();
                            ...
                            <div class="item-suggest-option-name">
                                ...
                                ${
                                    categoryName
                                        ...
                                        : (categoryId ? ' • <span class="text-muted">#' + categoryId + '</span>' : '')
                                }
                            </div>
                        `;

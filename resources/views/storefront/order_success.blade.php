...
<head>
    ...
    <title>Pesanan Diterima — Greatfit</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* NAV */
        .nav { background: rgba(255,255,255,.96); backdrop-filter: blur(12px); border-bottom: 1px solid var(--line); }
...
(function () {
    ...
    // Bangun pesan WA fallback jika session sudah expired
    ...
    document.getElementById('wa-btn').addEventListener('click', function (e) {
        ...
        // Tandai wa_click ke server (fire-and-forget)
        fetch(MARK_URL, {
            method: 'POST',

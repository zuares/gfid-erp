        ...
        @php
            ...
            $operatorOptions = collect($linesByOp)
                ...
                ->map(function ($l) {
                    ...
                    $label = trim(
                        ($l['operator_code'] ? $l['operator_code'] . ' — ' : '') . ($l['operator_name'] ?? ''),
                    );
        ...
        <div class="panel mb-2">
            <div class="panel-h d-flex align-items-start justify-content-between gap-2 flex-wrap">
                ...
                <a href="{{ route('production.finishing_jobs.index') }}" class="btn btn-sm btn-outline-primary"
                    style="border-radius:999px;">Riwayat</a>
            </div>
        </div>
...
<div class="list" id="list-all">
    ...
    @else
        @php
            // Build detail operator per item (dari linesByOp)
            ...
            // SUMMARY (ALL)
            $summaryRows = collect($linesAll)->filter(fn($l)=>(int)($l['total_wip'] ?? 0) > 0)->count(); // baris item
            $summaryQty  = collect($linesAll)->sum(fn($l)=> (int)($l['total_wip'] ?? 0));               // total WIP
        ...
        <div class="sum-box mb-2">
            <div class="sum-top">
                <div>
                    <div class="ttl">Summary (Belum Packing)</div>
                </div>
                <div class="text-end">
            ...
            <div class="sum-pillrow">
                ...
                <div class="sum-pill">
                    ...
                    <span class="val mono">{{ number_format($summaryQty,0,',','.') }}</span>
                </div>
                <div class="sum-pill">
    ...
    @endif
                        ...
                        @else
                            @foreach ($linesByOp as $idx => $line)
                                @php
                                    ...
                                    $opLabel = trim(
                                        ($line['operator_code'] ? $line['operator_code'] . ' — ' : '') .
                                            ($line['operator_name'] ?? ''),
                                    );
                                    if ($opLabel === '' && $opId > 0) {
                                        $opLabel = 'OP-' . $opId;
                                ...
                                <div class="cardx mono fin-item" data-idx="{{ $idx }}"
                                    ...
                                    data-operator-label="{{ $opLabel }}" data-code="{{ $code }}"
                                    data-wip="{{ $wip }}">
                                    <div class="cardx-h">
                                        ...
                                        <div class="grid2">
                                            <div class="field">
                                                ...
                                                <input type="text" inputmode="numeric"
                                                    ...
                                                    name="lines_byop[{{ $idx }}][qty_in]" value=""
                                                    placeholder="0">
                                            </div>
                                            <div class="field">
                                                <label>Reject</label>
                                                <input type="text" inputmode="numeric"
                                                    ...
                                                    name="lines_byop[{{ $idx }}][qty_reject]" value=""
                                                    placeholder="0">
                                            </div>
                                        </div>
                    ...
                    <div class="fab-wrap">
                        ...
                        <button type="button" class="btn btn-sm btn-primary fab-save" id="btn-open-modal"
                         ...
                         <div class="modal-body">
                                    <div class="sum-box">
                                        <div class="sum-top">
                                            <div>
                                                ...
                                                <div class="sub">Mode: <span class="mono" id="m-mode">ALL</span>
                                                </div>
                                            </div>
                                            <div class="text-end">
                                                <div class="sub">Baris: <span class="mono" id="m-rows">0</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="sum-pillrow">
                                            <div class="sum-pill"><span class="lbl">Total Setor</span><span
                                                    class="val mono" id="m-ok">0</span></div>
                                            <div class="sum-pill"><span class="lbl">Total Reject</span><span
                                                    class="val mono" id="m-rj">0</span></div>
                                            <div class="sum-pill"><span class="lbl">Total Qty</span><span
                                                    class="val mono" id="m-total">0</span></div>
                                        </div>
                                    </div>

                                    {{-- ALL: ACCORDION per operator --}}
                                    <div class="mt-3" id="wrap-all-summary">
                                        <div class="d-flex justify-content-between align-items-center gap-2 flex-wrap">
                                            <div style="font-weight:900;">Summary per Operator</div>
                                            <div class="text-muted" style="font-size:.78rem;font-weight:800;">
                                                Operator → Item & WIP
                                            </div>
                                        </div>
                                    ...
                                    <div class="mt-3" id="wrap-byop-detail" style="display:none;">
                                        <div class="d-flex justify-content-between align-items-center gap-2 flex-wrap">
                                            ...
                                            <div class="text-muted" style="font-size:.78rem;font-weight:800;">No • Kode
                                                Item • Setor • Reject</div>
                                        </div>
                                        ...
                                        <div class="table-responsive mt-2">
                                            <table class="table table-sm align-middle mb-0">
                                                ...
                                                <tbody id="byop-detail-body">
                                                    <tr>
                                                        <td colspan="4" class="text-muted text-center py-3">Belum ada
                                                            item dipilih.</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <input type="text" class="form-control form-control-sm" id="m-operator"
                                                readonly>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-sm btn-primary" id="modal-submit"
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // checklist ON: setor auto = sisa - reject
            ...
            // kalau user isi reject => setor otomatis jadi sisa - reject
            ...
            function setMode(mode) {
                ...
                if (mode === 'all') {
                    ...
                    // HIDE floating buttons saat gabung
                    ...
                    // tombol modal gak kepake di ALL (tapi kalau kamu masih mau modal summary, hapus baris ini)
                    btnOpenModal.disabled = true;
                } else {
                    listAll.style.display = 'none';
                    listByOp.style.display = '';

                    // SHOW floating buttons di byop
            ...
            function buildModalAllAccordion() {
                // group dari listByOp: itemCode -> { itemId, code, ops: Map(opLabel->wip) }
                ...
                // summary numbers
                let rowsCount = 0; // total baris operator (di semua item)
                let totalWip = 0;
                items.forEach(it => {
                    it.ops.forEach(v => {
                        rowsCount++;
                ...
                acc.innerHTML = items.map((it, idx) => {
                    ...
                    const collapseId =
                        `item-collapse-${(it.itemId||it.code).replace(/[^a-zA-Z0-9_-]/g,'')}-${idx}`;
                    const headingId =
                        `item-heading-${(it.itemId||it.code).replace(/[^a-zA-Z0-9_-]/g,'')}-${idx}`;
        ...
        <div class="accordion-item" style="border-radius:14px; overflow:hidden; border:1px solid rgba(148,163,184,.18); margin-bottom:.55rem;">
            ...
            <div id="${collapseId}" class="accordion-collapse collapse ${show}" aria-labelledby="${headingId}"
                 data-bs-parent="#all-ops-accordion">
                <div class="accordion-body" style="padding:.7rem .85rem;">
                    <div class="table-responsive">
                        <table class="table table-sm align-middle mb-0">
                            <thead>
        ...
        `).join('');
            ...
            opFilter?.addEventListener('change', () => {
                ...
                if (!selOpId) {
                    ...
                    // set hidden operator_global_id supaya store ga bingung
            ...
            form.addEventListener('input', (e) => {
                ...
                // kalau reject berubah => setor otomatis = sisa - reject
                if (isReject) {
                    applyRejectAffectsSetor(card);
                }

                // auto-check jika ada isi
            ...
            // checkbox handler (BYOP) => auto fill sisa
            ...
            if (modalEl && typeof bootstrap !== 'undefined') {
                ...
                modalSubmit?.addEventListener('click', () => {
                    ...
                    // normalize: blank qty_in => 0, blank qty_reject => 0
                    $$('.fin-item', listByOp).forEach(card => {
                        const {
                            qtyIn,
                            qtyRj,
            ...
            // init mode berdasarkan opFilter
            const initOp = (opFilter?.value || '').toString();
            if (!initOp) setMode('all');
            else {
                setMode('byop');

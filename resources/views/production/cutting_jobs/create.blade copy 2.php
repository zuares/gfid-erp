                ...
                <div class="cutting-card">
                    ...
                    <div class="cutting-card-body">
                        <div class="row g-2">
                            ...
                            <div class="col-md-3 col-12 cutting-notes-field">
                            ...
                            <table class="lot-list-table table table-sm mb-0 mono">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="d-none d-md-table-cell">Gudang</th>
                                    </tr>
                                </thead>
                                <tbody id="lot-list-body">
                                    @foreach ($lotStocks as $row)
                                        ...
                                        <tr class="lot-row" data-lot-id="{{ $row->lot_id }}"
                                            ...
                                            <td class="d-none d-md-table-cell">{{ $wh->code ?? '' }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
                            ...
                            <tr class="bundle-row">
                                ...
                                <td>
                                    <x-number-input name="bundles[__INDEX__][qty_pcs]" step="0.01" min="0"
                                        inputmode="decimal" size="sm" align="end"
                                        class="bundle-qty-pcs bundle-qty" />
                                </td>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function createBundleRow() {
                ...
                if (qtyInput) {
                    ...
                    // Fokus qty → scroll ke tengah (mobile-friendly)
            ...
            filterLotsByFabric();
            recalcLotBalanceFromCheckedLots();
            createBundleRow(); // minimal 1 baris pertama
        });
    </script>
@endpush

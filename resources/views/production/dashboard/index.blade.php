...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // ---- Filter realtime tab "Penjahit" (client-side, instan) ----
            const idRp = (n) => 'Rp ' + idFmt(Math.round(n || 0));

            // Tombol "Cetak Slip": tampil saat satu operator terpilih (per-tab).
            ...
            function applyPjFilters(root) {
                ...
                // Footer & area filter: total upah TERMASUK estimasi Ambil (sumProj).
                ...
                // KPI cards ikut ter-update mengikuti filter
            ...
            // ---- Filter realtime tab "Cutting" (client-side, instan) ----
            ...
            function initTabFilters(name, pane) {
                if (name === 'penjahit') applyPjFilters(pane);
                else if (name === 'cutting') applyCgFilters(pane);
                else if (name === 'prioritas') applyPrFilters(pane);
            }

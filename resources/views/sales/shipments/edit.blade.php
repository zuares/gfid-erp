                            ...
                            <form id="scanForm" method="POST"
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="text" name="scan_code" class="form-control scan-input" id="scanInput"
                                        placeholder="Fokus di sini lalu scan..." autocomplete="off" required>
                                </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="d-flex flex-wrap gap-2 align-items-center">
                        ...
                        <form id="importPreviewForm" method="POST"
                            ...
                            <input id="importFileInput" type="file" name="file"
                                class="d-none @error('file') is-invalid @enderror" accept=".csv,.txt,.xlsx,.xls" required>
    ...
    <script>
        (function() {
            ...
            window.addEventListener('load', function() {
                ...
                if (importPreviewModalEl && shouldAutoShowPreview && window.bootstrap &&
